  ...
  const targetProjects = [
    {
      ...
      projects: [
        ...
        {
          name: "Groq",
          description: "Fast LLM inference API with high-performance capabilities",
          reason: "Used in Digital Twin project for LLM integration, familiar with the API",
          firstSteps: ["API documentation", "Usage examples", "Community support"],
        },
      ],
    },
    {
